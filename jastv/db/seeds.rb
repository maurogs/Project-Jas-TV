...
program2_11 = Program.create(name: 'Vicky Cristina Barcelona', picture: 'cvicky_cristina_barcelona.jpeg', genre: "cine", website: 'http://www.filmaffinity.com/es/film546027.html')
...
episode2_11 = program2_11.episodes.create channel: la_2, showed_at:'23:00:00', duration: '1'
...
episode4_13 = program4_9.episodes.create channel: la_4, showed_at:'23:00:00', duration: '1'
...
episode5_8 = program5_7.episodes.create channel: la_5, showed_at:'22:00:00', duration: '1'
episode5_9 = program5_8.episodes.create channel: la_5, showed_at:'23:00:00', duration: '1'
...
episode6_11 = program6_9.episodes.create channel: la_6, showed_at:'23:00:00', duration: '1'
